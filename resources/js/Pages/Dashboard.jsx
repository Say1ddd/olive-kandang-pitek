        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-black/10 p-5 rounded-3xl grid xs:grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-2">
                            <div className="relative rounded-xl lg:rounded-t-xl lg:rounded-b-none shadow-sm p-5 hover:bg-black/20 border-slate-300 hover:border-blue-500 duration-300 border-2 flex items-center">
